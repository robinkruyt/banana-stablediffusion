...
# Install git
RUN apt-get update && apt-get install -y git curl wget libglib2.0-0 libglib2.0-0 libsm6 libxext6 libxrender-dev libgl1 && apt-get clean && rm -rf /var/lib/apt/lists/*
